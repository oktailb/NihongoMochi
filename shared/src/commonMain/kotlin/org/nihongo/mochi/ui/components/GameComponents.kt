            ...
            for (i in 0 until maxItems) {
                ...
                if (status != null) {
                    val icon = when (status) {
                        GameStatus.CORRECT -> Icons.Default.CheckCircle
                        GameStatus.INCORRECT -> Icons.Default.Close
                        GameStatus.PARTIAL -> Icons.Default.History
                ...
                Box(modifier = Modifier.fillMaxSize()) {
                    if (secondaryText != null) {
                        Icon(
                            ...
                            contentDescription = "Flip for info",
                            modifier = Modifier
