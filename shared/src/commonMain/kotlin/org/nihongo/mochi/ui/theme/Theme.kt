...
import org.nihongo.mochi.shared.generated.resources.notosansjp_regular
...
// Custom Typography based on MaterialTheme's default but with a Japanese font for Kanji
@Composable
fun mochiTypography(): Typography {
    val japaneseFontFamily = FontFamily(Font(Res.font.notosansjp_regular))
    return remember(japaneseFontFamily) {
        Typography(
...
fun AppTheme(
    ...
    MaterialTheme(
        ...
        typography = mochiTypography(), // Use custom typography
        content = content
    )
}
