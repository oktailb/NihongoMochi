...
fun WritingScreen(
    ...
    MochiBackground {
        Column(
            ...
            Text(
                text = stringResource(Res.string.writing_title),
                fontSize = 34.sp,
            ...
            Text(
                text = stringResource(Res.string.writing_subtitle),
                fontSize = 16.sp,
            ...
            // User Lists Section
            WritingCard(title = stringResource(Res.string.writing_user_lists)) {
                WritingLevelButton(
                    info = userListInfo,
                    displayName = stringResource(Res.string.writing_user_lists), // Or handle via getCategoryTitle if needed
                    onClick = onLevelClick,
