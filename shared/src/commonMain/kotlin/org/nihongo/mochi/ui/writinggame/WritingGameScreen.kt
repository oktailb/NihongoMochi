                        ...
                        Surface(
                            ...
                            Text(
                                text = if (questionType == QuestionType.MEANING) 
                                    stringResource(Res.string.game_writing_label_meaning) 
                                else 
                                    stringResource(Res.string.game_writing_label_reading),
...
fun CorrectionCard(
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = stringResource(Res.string.game_writing_correction),
                style = MaterialTheme.typography.titleMedium,
            ...
            if (questionType == QuestionType.MEANING) {
                ...
                Row(
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(Res.string.game_writing_on),
                            fontWeight = FontWeight.Bold,
                            color = MaterialTheme.colorScheme.onErrorContainer
                        )
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(Res.string.game_writing_kun),
                            fontWeight = FontWeight.Bold,
                            color = MaterialTheme.colorScheme.onErrorContainer
                        )
